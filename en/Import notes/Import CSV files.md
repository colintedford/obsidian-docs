...
---
Obsidian lets you import data from CSV files using the official [[Importer|Importer plugin]]. This is useful if you have tabular data stored in apps such as Excel, Google Sheets, Numbers, Notion, or Airtable.
